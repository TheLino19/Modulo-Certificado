...
<html>
  <head>
    <meta charset="UTF-8"/>
    <link rel="stylesheet" href="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/styles/style_pdf.css?v=<?php echo time(); ?>">
  </head>
  <body>
    <img class="bg_pdf" src="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/assets/img/bg_pdf.jpg" alt="background">
    <main>
      <div class="container_main">
        ...
        <section class="publishers_signatures">     
          ...
          <img src="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/assets/img/firma<?php echo $journal?>.jpg" alt="firma_<?php echo $journal?>">
        </section>
