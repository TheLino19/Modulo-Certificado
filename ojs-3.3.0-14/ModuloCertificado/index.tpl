...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/styles/style_page.css?v=<?php echo time(); ?>" />
</head>
...
<body>
      ...
      <div class="consulta_content">
        ...
        <form action="POST" class="consulta_form" id="frm">
          <div class="container_imputs">
            <input class="txt_id" type="search" placeholder="Buscar" name="campo" value="{$revistaTitle}" required />
  ...
  <script src="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/js/certificado.js"></script>
</body>
</html>